    ...
    <>
      ...
      <div className="modal sm:modal-middle modal-bottom">
        <div className="modal-box">
          ...
          <div className="h-50vh overflow-x-hidden overflow-y-scroll prose sm:lh-loose lh-normal">
            <h4>信息来源</h4>
            <p>
              网站信息在通过阅读
              ...
              后，总结而来，部分信息取自该文章，不会商用，仅供学习练手交流使用，如有侵权请联系我删除。
            </p>
            <p>
              本站使用了PWA技术，可以直接发送到桌面作为APP使用，全程无需联网，数据存储在IndexedDB中，首次访问后，后续可以离线访问。
            </p>
            <h4>使用指南</h4>
            <ul>
              <li>
